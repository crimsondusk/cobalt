...
public:
	...
	public:
		Entry( IRCUser* user, Status stat ) : m_userinfo( user ), m_status( stat ) {}
	...
	READ_PROPERTY( Time, joinTime, setJoinTime )
...
private:
	vector<Entry> m_userlist;
	vector<Mode> m_modes;
	vector<str> m_banlist, m_whitelist, m_invitelist;
};
