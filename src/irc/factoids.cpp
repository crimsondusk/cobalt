...
// =============================================================================
// -----------------------------------------------------------------------------
IRC_COMMAND (learn, Normal, false)
{	if (parms.size() < 3)
	...
	if (!G_FactsXML->save ("facts.xml"))
		IRC_REPLY ("Failed to save facts.xml with the new data: %1\n", strerror (errno));
...
// =============================================================================
// -----------------------------------------------------------------------------
IRC_COMMAND (about, Normal, false)
{	if (parms.size() < 2)
...
// =============================================================================
// -----------------------------------------------------------------------------
IRC_COMMAND (factoid_meta, Normal, false)
{	if (parms.size() < 2)
	{	IRC_REPLY ("Usage: %1 <subject>", parms[0]);
		return;
	}
